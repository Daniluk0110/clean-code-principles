...
Раздел о принципе YAGNI (You Aren't Gonna Need It) — не писать код "про запас". Если фичи нет в текущем ТЗ, то преждевременные абстракции тратят время и усложняют поддержку. Гораздо дешевле добавить расширение, когда оно действительно нужно.
